...
var res = jv({
    ...
    "colors": {
        ...
        "editorGutter.foldingControlForeground" : "{color_hilight}",
        ...
        "input.border": "{color_bg_light}",
        "input.foreground": "{color_hilight}",
        "input.placeholderForeground": "{dimmed_txt}",
        "inputOption.activeBackground": "{color_bg_dark}",
        "inputOption.activeBorder": "{color_bg_light}",
        "inputOption.activeForeground": "{color_hilight}",
